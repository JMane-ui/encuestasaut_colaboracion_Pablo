...
class Survey_model extends CI_Model{
    ...
    public function get_question_forms($user_id=FALSE , $form_id=FALSE)
    {
        ...
        {
            $this->db->select('qf.id as "question_form_id" , qf.title as "title", qf.description as "description", qf.objective as "objective", q.id as "question_id" ,  q.body as "question" , q.type as "type" , q.required as "required" , p.body as "proposition"');
    ...
    {
        $sql = 'select count(id) as "count" from answer_forms where created_at = ? ;';
    ...
    public function edit_question_form($id,$title,$description,$objective,$slug,$survey_img)
    {
        $data = array(
            'title' => $title,
    ...
    public function store_question_form($title,$description,$objective,$slug,$user_id,$survey_img)
    {
        $data = array(
            'title' => $title,
            'description' => $description,
    ...
    {
        $this->db->select( 'u.name as "user", qf.id as "question_form_id" , qf.title as "title", qf.description as "description", qf.objective as "objective" , q.id as "question_id" , q.body as "question" , q.type as "type" , q.required as "required" , p.body as "proposition"');
        $this->db->from('question_forms qf');
        $this->db->join('users u' , 'qf.user_id = u.id');
        $this->db->join('questions q' , 'qf.id = q.question_form_id');
        $this->db->join('propositions p' , 'q.id = p.question_id' , 'left');
